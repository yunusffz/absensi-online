...
const FormMatkul = React.lazy(() => import('./views/Matkul/FormMatkul'));
const Kelas = React.lazy(() => import('./views/Kelas/Kelas'));
const FormKelas = React.lazy(() => import('./views/Kelas/FormKelas'));
const Jadwal = React.lazy(() => import('./views/Jadwal/Jadwal'));
const FormJadwal = React.lazy(() => import('./views/Jadwal/FormJadwal'));
...
const routes = [
  ...
  { path: '/matkul', exact:true, name: 'Mata Kuliah', component: Matkul },
  { path: '/matkul/form', exact:true, name: 'Detail Mata Kuliah', component: FormMatkul },
  { path: '/kelas', exact:true, name: 'Kelas', component: Kelas },
  { path: '/kelas/form', exact:true, name: 'Detail Kelas', component: FormKelas },
  { path: '/jadwal', exact:true, name: 'Jadwal', component: Jadwal },
  { path: '/jadwal/form', exact:true, name: 'Detail Jadwal', component: FormJadwal },
];
